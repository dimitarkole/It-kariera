...
namespace StorageMaster.Entitys.Storages
{
    ...
    public abstract class Storage
    {
        ...
        {
            this.Name = name;
            this.AutometeWerehoudeCapacity = capacity;
        ...
        public int AutometeWerehoudeCapacity{ get; private set; }

        public int GarageSlots { get; private set; }

        public bool IsFull => 
            this.products.Sum(p=>p.Weight) >= this.AutometeWerehoudeCapacity;
