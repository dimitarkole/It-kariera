...
{
    using global::StorageMaster.Entitys.Storages;
    using global::StorageMaster.Entitys.Vehicles;
    using System;
    ...
    public class StorageMaster
    {
        ...
        {
            Product product = CrearePodeuct(type, price);
        ...
        public string GetStorageStatus(string storageName)
        {
            ...
            string stockLine = $"Stock({ productCounts}/" +
                $"{storage.AutometeWerehoudeCapacity}): [{string.Join(", ", sortedProduct)}]";
        ...
        public string GetSummary()
        {
            ...
            foreach (var storage in sortedStorage)
            {
                ...
                sb.AppendLine($"Storage worth: {totalProce}");
            }
        ...
        private Product CrearePodeuct(string type, double price)
        {
